...
const TimeSlider: React.FC<TimeSliderProps> = ({ 
  ...
  return (
    <div className="absolute bottom-24 sm:bottom-8 left-1/2 -translate-x-1/2 z-[900] w-[92%] max-w-lg bg-neutral-900/90 backdrop-blur-md border border-neutral-700 rounded-lg shadow-xl px-4 py-3 flex flex-col gap-1">
